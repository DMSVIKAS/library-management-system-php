...
if(isset($_POST['submit']))
{
    ...
    $query = "UPDATE books SET name=?, authors=?, edition=?, status=?, quantity=?, department=? WHERE bid=?";
    ...
    mysqli_stmt_bind_param($stmt, "ssssiss", $name, $authors, $edition, $status, $quantity, $department, $bid);
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        ?>
        <script type="text/javascript">
            alert("Error updating book: <?php echo mysqli_error($db); ?>");
        </script>
        <?php
    }
